...
public class OtherUserSignInStrategy implements SignInStrategy {
    ...
    /**
     * This method perform the login with another username account.
     * If the username is the correct return dashboard page,
     * if the username isn't correct return dashboard but
     * before leave the session and sign in with the correct
     * user.
     *
